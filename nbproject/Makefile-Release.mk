...
${OBJECTDIR}/src/BookingSystemManager.o: src/BookingSystemManager.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BookingSystemManager.o src/BookingSystemManager.cpp
...
${OBJECTDIR}/src/InputManager.o: src/InputManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/InputManager.o src/InputManager.cpp
...
${OBJECTDIR}/src/mydb_class.o: src/mydb_class.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mydb_class.o src/mydb_class.cpp
